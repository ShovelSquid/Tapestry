...
- Stay on the branch this worktree has checked out. Never switch, create or
...
- Commit messages follow the repo's GSD style (`feat(<phase>-<plan>): …`,
  `docs(<phase>): …`) and end with

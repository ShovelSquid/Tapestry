...
| 11 | In hands-face-voice/scene3d.js, replace the hard SNAP_THRESHOLD jump with a smoothstep gradient between MIN_SMOOTHING_FACTOR and a capped MAX_SMOOTHING_FACTOR so fast motion eases smoothly instead of teleporting | 2026-09-24 | a90f496 | — |
